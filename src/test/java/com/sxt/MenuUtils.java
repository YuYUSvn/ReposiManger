...
class MenuUtils {
    ...
    void initPermisstion(){
        menuService.save(new Menu(23,6,"permission","customer:query","客户查询","fa fa-gear","",null,0,23,1));
        menuService.save(new Menu(24,6,"permission","customer:add","客户添加","fa fa-gear","",null,0,24,1));
        menuService.save(new Menu(25,6,"permission","customer:delete","客户删除","fa fa-gear","",null,0,25,1));
        menuService.save(new Menu(26,6,"permission","customer:update","客户更新","fa fa-gear","",null,0,26,1));
    }
